...
public class SubjectChart extends AbstractDemoChart{

	private String costSubject [] =null;
	private double[] costMoney =null;
	private int n=0;
	
	public SubjectChart(String costSubject [],double costMoney []){
	...
	public Intent execute(Context context) {
		// TODO Auto-generated method stub
		String titles[]  =new String[]{ "科目"};//图例  
		n=costSubject.length;
...
*/		values.add(costMoney);
		...
		setChartSettings(renderer, "个人支出报表", "科目", "金额", 0.5,  
		...
		for(int i=0;i<n;i++)
	    {
	    	...
	    	renderer.addXTextLabel(i+1, costSubject[i]);
	    }
